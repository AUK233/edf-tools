			...
			for (int i = 0; i < ObjectCount; i++)
			{
				...
				for (int j = 0; j < objects.back().infoCount; j++)
				{
					...
					for (int k = 0; k < Layoutnum; k++)
					{
						...
						else if (objects_layout.back().type == 4)
						{
							for (int l = 0; l < Vnum; l++)
							{
								int Vcurpos = Voffset + (l * Vsize);
						...
						else if (objects_layout.back().type == 7)
						{
							for (int l = 0; l < Vnum; l++)
							{
								int Vcurpos = Voffset + (l * Vsize);
						...
						else if (objects_layout.back().type == 12)
						{
							for (int l = 0; l < Vnum; l++)
							{
								int Vcurpos = Voffset + (l * Vsize);
						...
						else if (objects_layout.back().type == 21)
						{
							for (int l = 0; l < Vnum; l++)
							{
								int Vcurpos = Voffset + (l * Vsize);
